...
Interaction buttons use emojis and pronoun-aware descriptions. Dating and nonsexual Flirt start at ten, with minor/adult pairing blocked. Hook up and Make love require both characters to be adults (18+). Dating partners show Boyfriend/Girlfriend and Make love replaces Hook up. Adult intimacy uses mutual preferences, relationship strength, and enjoyment bars; hookups also use player Looks and a penalty when already dating someone else. Stat effects remain once per action/person/year. Bank balance sits to the right of Schedule, and school/work contact relationship bars are wider.
