...
- School progression, program durations, tuition models and professional license requirements are national. Existing school transitions at ages 6, 12 and 18 remain unchanged. No in-state/out-of-state tuition differential.
...
- Community colleges offer 16 employment-focused associate majors (two years) and eight career certificate subjects (one year), reusing university major IDs. Human Resources remains a university major; Business Administration covers community college preparation for entry-level HR work. Transfer routes remain future work; research doctorates are omitted. IT support uses a high-school baseline with Computer Science/IT qualifications preferred.
