...
export type Choice = { label: string; hint: string; disabled?: boolean; outcome: string; effect?: Partial<Stats>; schoolAction?: import('./occupation').SchoolAction; schoolEffect?: { grades?: number; popularity?: number }; relationship?: { id: string; action: import('./relationships').RelationshipAction; giftId?: string } };
