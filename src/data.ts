...
export type Choice = { label: string; hint: string; disabled?: boolean; outcome: string; effect?: Partial<Stats>; familyEffect?: FamilyRelationshipEffect; jobDecision?:{id:string}; friendshipDecision?:{id:string;salvage:boolean}; relationshipResponse?:{id:string;accept:boolean}; membershipAction?:{id:string;action:import('./schoolCommitments').MembershipAction}; schoolActivityDecision?:{id:string}; workAction?:import('./partTimeWork').WorkAction; schoolAction?: import('./occupation').SchoolAction; schoolEffect?: { grades?: number; popularity?: number }; relationship?: { id: string; action: import('./relationships').RelationshipAction; giftId?: string;invited?:boolean } };
export type LifeEvent = { icon?:string; meters?:{name:string;value:number}[]; profileId?:string; category: string; title: string; text: string; choices: Choice[] };
