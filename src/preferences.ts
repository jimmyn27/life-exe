...
export function npcSexuality(lifeId:string,personId:string):Sexuality {const value=seededRandom(`${lifeId}:${personId}:sexuality`)();return value<.93?'Straight':value<.97?'Bisexual':'Gay';}
