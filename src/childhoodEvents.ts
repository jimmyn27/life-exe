...
const ageTwo:LifeEvent[] = [
 event('A playground adventure','The playground appearance enormous, with slides, swings, and climbing bars.','🛝',[
 ...
 event('A rainy afternoon','Rain taps against the windows while you are stuck indoors.','🎨',[
  choice('Finger paint','I made a colorful finger painting.',{Intelligence:2,Happiness:3,Appearance:1}),
 ...
 event('The family photograph','Everyone gathers together for a family picture.','📷',[
  choice('Give a big smile','I smiled brightly for our family photograph.',{Happiness:2,Appearance:2},{parents:2,siblings:2}),
...
const ageThree:LifeEvent[] = [
 event('Getting dressed','You insist that you can choose your own clothes today.','👕',[
  choice('Pick a matching outfit','I chose my own matching outfit.',{Intelligence:2,Appearance:2}),
  choice('Wear every color','I wore as many colors as I could find.',{Happiness:3,Appearance:1}),
 ...
 event('Baking with family','Your family is making cookies in the kitchen.','🍪',[
  ...
  choice('Decorate the cookies','I covered our cookies in colorful decorations.',{Happiness:3,Appearance:1},{parents:2}),
 ...
 event('A game with my sibling','Your sibling invites you to play a game together.','🎲',[
  choice('Play fairly','I played a game fairly with my sibling.',{Intelligence:2,Happiness:2},{siblings:4}),
...
const ageFour:LifeEvent[] = [
 event('The broken vase','A vase falls and breaks while you are playing nearby.','🏺',[
  choice('Tell the truth','I admitted that I broke a vase while playing.',{Intelligence:2},{parents:3}),
  choice('Blame my sibling','I blamed my sibling for the broken vase.',{Happiness:-1},{parents:-2,siblings:-6}),
  choice('Help clean up','I told the truth and helped my parent clean up the broken vase.',{Intelligence:2,Health:1},{parents:5}),
 ...
 event('Drawing my family','You sit down with crayons and decide to draw everyone in your family.','🖍️',[
  choice('Draw everyone together','I drew a picture of my whole family together.',{Intelligence:2,Appearance:1,Happiness:2},{parents:2,siblings:2}),
...
const ageFive:LifeEvent[] = [
 ...
 event('A birthday party','You are invited to a child’s birthday party.','🎂',[
  choice('Join every game','I joined every game at a birthday party.',{Happiness:4,Health:2}),
  choice('Make a new friend','I introduced myself to another child at the party.',{Happiness:3,Appearance:1}),
 ...
 event('Helping my sibling','Your sibling is struggling with something that you understand.','🤲',[
  choice('Show them how','I patiently showed my sibling how to do it.',{Intelligence:2,Happiness:2},{siblings:5}),
 ...
 event('A neighborhood game','Some children nearby invite you to join their game.','⚽',[
  choice('Play enthusiastically','I joined a neighborhood game and played my hardest.',{Health:6,Happiness:3}),
  choice('Suggest a new game','I taught the other children a game I knew.',{Intelligence:2,Happiness:3}),
  choice('Watch from the side','I watched the neighborhood children play.',{Intelligence:1,Happiness:-1})]),
...
const later:Record<number,LifeEvent> = {
 ...
 10:event('Starting middle school','Elementary school is complete. You have started middle school with new classes and classmates.','🏫',[choice('Focus on my classes','I started middle school and focused on my classes.',{Intelligence:3},undefined,'Shape your childhood.',{grades:4}),choice('Get to know my classmates','I started middle school and got to know my classmates.',{Happiness:3},undefined,'Shape your childhood.',{popularity:4})],'Education'),
